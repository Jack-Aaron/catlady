            ...
            <Card.Body>
              ...
              <Form className="login">
                <Form.Group className="form-group">
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id={`popover`}>
                          ...
                          <Popover.Content>
                            It is normally available on the manufacture's
                            website and on the package under guaranteed
                            analysis.
                          </Popover.Content>
                        </Popover>
                      }
                  ...
                  <Input onChange={handleChange} name="calPer" type="text" />
                  <Form.Label className="mt-3">Oz Per Package: </Form.Label>
                  <Input onChange={handleChange} name="ozPer" type="text" />
                ...
                <Button
                  disabled={
                    !(form.name && form.calPer && form.ozPer && form.petType)
                  }
